...
public class PemberitahuanPengelolaBaru extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btnDetailPengelola;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pemberitahuan_pengelola_baru);
        ...
        btnDetailPengelola = (Button) findViewById(R.id.btnDetailPengelola);

        btnDetailPengelola.setOnClickListener(this);
        ...
        //firestore
        firebaseFirestore.collection("pemberitahuans").document(idPemberitahuan).addSnapshotListener(PemberitahuanPengelolaBaru.this, new EventListener<DocumentSnapshot>() {
            @Override
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.btnDetailPengelola:
                Intent i = new Intent(PemberitahuanPengelolaBaru.this, DetailVerifikasiUser.class);
