...
public class PemberitahuanTransfer extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pemberitahuan_transfer);
        ...
        //get data pembayaran
        firebaseFirestore.collection("pemesanans").document(idPemesanan).addSnapshotListener(PemberitahuanTransfer.this, new EventListener<DocumentSnapshot>() {
            @Override
        ...
        //get data kost
        firebaseFirestore.collection("data_kost").document(idKost).addSnapshotListener(PemberitahuanTransfer.this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot.exists()){
        ...
        firebaseFirestore.collection("pemberitahuans").document(idPemberitahuan).addSnapshotListener(PemberitahuanTransfer.this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btnDetailPembayaran:
                Intent i = new Intent(PemberitahuanTransfer.this , DetailPemesananPengguna.class);
