...
public class UpdateLokasi extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback, MapboxMap.OnMapClickListener {
    ...
    static UpdateLokasi updateLokasi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseFirestore.collection("preferensi").document(firebaseAuth.getCurrentUser().getUid()).addSnapshotListener(UpdateLokasi.this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot.exists()){
                    Preferensi data = documentSnapshot.toObject(Preferensi.class);
                    editNamaLokasi.setText(data.getNamaLokasi());
                }
            }
        });
    ...
    private void simpanLokasiPencarian(){
        ...
        firebaseFirestore.collection("preferensi").document(firebaseAuth.getCurrentUser().getUid()).update(location).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Intent i = new Intent(UpdateLokasi.this, HomeActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void getLocation(){
        ...
        if(!alamat.isEmpty()){
            Geocoder geocoder = new Geocoder(UpdateLokasi.this, Locale.getDefault());
            try {
    ...
    public static UpdateLokasi getInstance(){
        return   updateLokasi;
    }
}