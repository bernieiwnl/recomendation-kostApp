...
public class PemesananKostAdapter extends  RecyclerView.Adapter<PemesananKostAdapter.MyViewHolder> {
    ...
    public PemesananKostAdapter(Context c, ArrayList<Pemesanan> pemesanans){
        this.c = c;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PemesananKostAdapter.MyViewHolder(LayoutInflater.from(c).inflate(R.layout.single_list_pemesanan_kost, parent , false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(c,  DetailPemesananPengelola.class);
