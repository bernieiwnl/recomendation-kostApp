...
public class FasilitasUmum implements Serializable {
    ...
    public FasilitasUmum(String nama_fasilitas, String foto_url, Integer nilai, String idfasilitas, List<String> idkosts){
