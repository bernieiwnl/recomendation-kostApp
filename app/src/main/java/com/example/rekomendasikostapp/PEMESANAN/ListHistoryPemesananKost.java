...
import com.example.rekomendasikostapp.ADAPTER.HistoryPemesananAdapter;
...
public class ListHistoryPemesananKost extends AppCompatActivity {

    private RecyclerView recyclerViewPemesanan;
    private FirebaseFirestore firebaseFirestore;
    private FirebaseAuth firebaseAuth;
    private ArrayList<Pemesanan> pemesanans;
    private HistoryPemesananAdapter historyPemesananAdapter;
    private ImageView empty_message;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_history_pemesanan_kost);
        ...
        firebaseFirestore.collection("pemesanans").whereEqualTo("idUser", firebaseAuth.getCurrentUser().getUid()).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                historyPemesananAdapter = new HistoryPemesananAdapter(ListHistoryPemesananKost.this , pemesanans);
                recyclerViewPemesanan.setAdapter(historyPemesananAdapter);
            }
        });
